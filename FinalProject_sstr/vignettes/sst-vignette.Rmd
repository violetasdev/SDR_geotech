...
vignette: >
  %\VignetteIndexEntry{Spectral Solution for Matching Graphs}
...
A version of the Pagerank function library exists in the igraph library but it needs as arguments criteria not needed in the current analysis. For the viability of using a simple already organized matrix with an identified direct graph, an initial implementation of the Pagerank algorithm is coded in the library SST.
