...
#' Generates the affinity scores with the Page rank algorithm by Google from igraph
#'
#' Returns an object of class matrix with the affinity scores
#' @importFrom igraph graph_from_adjacency_matrix
#' @importFrom igraph page_rank
#' @importFrom methods as
#' @param simMatrix similarity matrix object handed by the user, it should be squared and it will be treated as a direct graph
#' @return score matrix for a similarity matrix
#' @export
